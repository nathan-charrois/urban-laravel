    ...
    <body>
        <div style="padding:25px;">
            ...
            <p style="color:#444;">
                ...
                <a href="{{ URL::to('auth/verify/' . $user->token) }}" style="width:90px;text-align:center;margin-top:50px;display:block;background-color:#f66051;padding:10px;color:white;text-decoration:none;">
                    Verify Account
                </a>
            </p>
        </div>
